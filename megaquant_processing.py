...
import requests
url = 'https://hse.kamran.uz/share/df_fin_train_feature_complex_fillna_iv.joblib'
r = requests.get(url, allow_redirects=True)
open('df_fin_train_feature_complex_fillna_iv.joblib', 'wb').write(r.content)
...
# для woe трансформации 
feat_iv                                    = load('feat_iv.joblib')
df_fin_train_feature_complex_fillna_iv_fin = load('df_fin_train_feature_complex_fillna_iv_fin.joblib')
df_fin_train_feature_complex_fillna_iv     = load('df_fin_train_feature_complex_fillna_iv.joblib')
test_feat_iv                               = load('test_feat_iv.joblib')
